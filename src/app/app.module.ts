...
@NgModule({
    ...
    declarations: [ContainerComponent, HeaderComponent, FooterComponent,ContentComponent], // Used to register components/services
    bootstrap: [ContainerComponent] // container required at startup
})
